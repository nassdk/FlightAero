package com.nassdk.corecommon.delegate
...
/**
 * Класс скопирован https://github.com/kirich1409/ViewBindingPropertyDelegate/blob/master/vbpd/
 * vbpd-noreflection/src/main/java/by/kirich1409/viewbindingdelegate/ViewBindingProperty.kt
 */

internal abstract class ViewBindingProperty<in R : Any, T : ViewBinding>(
